...
/*
*	Agrega un elemento a la lista ordenada de sensores, ordenada por id
*	A este elemento se le asigna el id y el nombre pasados como argumentos
*	En caso de error retorna un ErrorCode y en el caso de no encontrar error retorna NOE
*/
int sensors_add(Sensors self, unsigned int id, char *name);

/*
*	Retorna 1 si el sensor existe y 0 si no existe, recibiendo el id del sensor a encontrar
*/
int sensors_exists(Sensors self, unsigned int id);

/*
*	Retorna 1 si el sensor existe y 0 si no existe, recibiendo el id del sensor a encontrar
*	En caso de que exista devuelve el nombre del sensor en la puntero pasado como argumento (No devuelve una copia del mismo)
*/
