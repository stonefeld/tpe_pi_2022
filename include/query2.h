...
/*
*	Crea una lista encadenada de los datos de la query 2 vacia
*/
Query2 query2_new(void);

/*
*	Llama a una funcion la cual agrega ordenadamente un elemento a la lista de la query 2, pasando como argumentos funcion de comparacion y funcion de igualdad 
*	A este elemento se le asigna el año y el count pasados como argumentos
...
/*
*	Libera los recursos usados por la query 2
*/
