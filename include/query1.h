 ...
 * la query1, pasando como argumentos funcion de comparacion y funcion de
 * igualdad A este elemento se le asigna el nombre, el id y el count pasados
 * como argumentos. En caso de error retorna un ErrorCode y en el caso de no
 ...
 * la matriz. En caso de error retorna un ErrorCode y en el caso de no encontrar
 * error retorna NOE.
 */
